...
--
-- Table structure for table `city_restaurant`
--

DROP TABLE IF EXISTS `city_restaurant`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `city_restaurant` (
  ...
  KEY `city_id` (`city_id`),
  CONSTRAINT `city_restaurant_ibfk_1` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurant` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `city_restaurant_ibfk_2` FOREIGN KEY (`city_id`) REFERENCES `city` (`ID`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `city_restaurant`
--

LOCK TABLES `city_restaurant` WRITE;
/*!40000 ALTER TABLE `city_restaurant` DISABLE KEYS */;
INSERT INTO `city_restaurant` VALUES
(1,459),
(1,1787),
(3,144),
(3,145),
...
(9,3357),
(9,3580);
/*!40000 ALTER TABLE `city_restaurant` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-12-06 23:05:54
